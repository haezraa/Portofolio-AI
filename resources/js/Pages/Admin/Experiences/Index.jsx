                    ...
                    <table className="w-full">
                        <thead className="border-b border-neutral-800 bg-neutral-900/50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-neutral-400 uppercase tracking-wider">Position</th>
                        ...
                        <tbody className="divide-y divide-neutral-800">
                            {experiences.map((exp) => (
                                <tr key={exp.id} className="hover:bg-neutral-900/30 transition-colors">
                                    <td className="px-6 py-4 text-sm text-neutral-200">{exp.company_or_organization}</td>
                                    <td className="px-6 py-4 text-sm text-neutral-400">{exp.position}</td>
